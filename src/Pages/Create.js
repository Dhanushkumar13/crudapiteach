        ...
        <div className='w-50 border bg-white shadow px-5 pt-3 pb-5 rounded'>
            ...
            <form onSubmit={handleSubmit}> 
                ...
                <div className='mb-2'>
                    ...
                    <input type='text' name='email' className='form-control' placeholder='Enter EmailId' onChange={e => setValues({...values, email: e.target.value})}/>
                </div>
                <div className='mb-3'>
